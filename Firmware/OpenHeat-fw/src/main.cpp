...
PID MyPID(&TipTemperature, &PID_Output, ptr_PID_Setpoint, aggKp, aggKi, aggKd, DIRECT);
/////////////////////////////////////////////////////////////////

char* TipName = "文件系统错误：请上报";

float ReadyTemp = 50;      //预备温度，防止上电瞬间电流过大导致开关电源短路保护          (°C)
double offset_ReadyTemp = 0; //预备温度偏移
float BootTemp = 100;      //开机温度          (°C)
float SleepTemp = 100;     //休眠温度          (°C)
...
void loop()
{
    ...
    {
        //温度闭环控制
        TemperatureControlLoop(thermocouple);
