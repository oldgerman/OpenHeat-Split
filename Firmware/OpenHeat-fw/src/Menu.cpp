...
struct Slide_Bar Slide_space[] = {
    ...
    {(float*) &readyKp,               0,   50,   0.1},
    {(float*) &readyKi,               0,   50,   0.1},
    {(float*) &readyKd,               0,   50,   0.1},
...
struct Menu_Level_System MenuLevel[] = {
    ...
    {16, 0, 0, 4,            Menu_NULL_IMG},
    {17, 0, 0, 4,            Menu_NULL_IMG},
    {18, 0, 0, 4,            Menu_NULL_IMG},
    {19, 0, 0, 4,            Menu_NULL_IMG},
    {20, 0, 0, 5,            Menu_NULL_IMG},
    {21, 0, 0, 4,            Menu_NULL_IMG},
    {22, 0, 0, 4,            Menu_NULL_IMG},
...
struct Menu_System Menu[] = {
    ...
    {1,  1,  Jump_Menu_Op,         "热床",     IMG_Bed,               2,                                  0,     Menu_NULL_F},
    {1,  2,  Jump_Menu_Op,         "温度场景",    Set1,                  3,                                  0,     Menu_NULL_F},
    {1,  3,  Jump_Menu_Op,         "定时场景",    Set2,                  4,                                  0,     Menu_NULL_F},
    {1,  4,  Jump_Menu_Op,         "温控设置",    Set3,                  20,                                 0,     Menu_NULL_F},
    {1,  5,  Jump_Menu_Op,         "返回",      Set7,                  0,                                  1,     Menu_NULL_F},

    {2,  0,  Title_Menu_Op,        "热床管理",       Menu_NULL_IMG,     1,                                  1,     Menu_NULL_F},
    ...
    {3,  1,  Progress_Bar_Menu_Op, "预备温度",    Set20,                 Slide_space_ReadyTemp,               0,     Menu_NULL_F},
    {3,  2,  Progress_Bar_Menu_Op, "启动温度",    Set13,                 Slide_space_BootTemp,               0,     Menu_NULL_F},
    {3,  3,  Progress_Bar_Menu_Op, "提温温度",    Set14,                 Slide_space_BoostTemp,              0,     Menu_NULL_F},
    {3,  4,  Progress_Bar_Menu_Op, "休眠温度",    Set11,                 Slide_space_SleepTemp,              0,     Menu_NULL_F},
    {3,  5,  Jump_Menu_Op,         "返回",      Save,                  1,                                  2,     Menu_NULL_F},
    ...
    {5,  2,  Jump_Menu_Op,         "蓝牙",      IMG_BLE,               23,                                 0,     Menu_NULL_F},
    ...
    {15, 0,  Title_Menu_Op,        "温度配置列表",       Menu_NULL_IMG,     2,                                  1,            *LoadTipConfig},
    ...
    {16, 1,  Jump_Menu_Op,         "PID预备期参数",    Menu_NULL_IMG,     17,                               0,     Menu_NULL_F},
    {16, 2,  Jump_Menu_Op,         "PID爬升期参数",    Menu_NULL_IMG,     18,                               0,     Menu_NULL_F},
    {16, 3,  Jump_Menu_Op,         "PID接近期参数",    Menu_NULL_IMG,     19,                               0,     Menu_NULL_F},
    {16, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     2,                                  3,     Menu_NULL_F},

    {17, 0,  Title_Menu_Op,        "PID预备期",      Menu_NULL_IMG,     16,                                1,            *SaveTipConfig},
    {17, 1,  Progress_Bar_Menu_Op, "比例P",         Menu_NULL_IMG,     Slide_space_PID_RP,                 0,     Menu_NULL_F},
    {17, 2,  Progress_Bar_Menu_Op, "积分I",         Menu_NULL_IMG,     Slide_space_PID_RI,                 0,     Menu_NULL_F},
    {17, 3,  Progress_Bar_Menu_Op, "微分D",         Menu_NULL_IMG,     Slide_space_PID_RD,                 0,     Menu_NULL_F},
    {17, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     16,                                 1,            *SaveTipConfig},

    {18, 0,  Title_Menu_Op,        "PID爬升期",      Menu_NULL_IMG,     16,                                2,            *SaveTipConfig},
    {18, 1,  Progress_Bar_Menu_Op, "比例P",         Menu_NULL_IMG,     Slide_space_PID_AP,                 0,     Menu_NULL_F},
    {18, 2,  Progress_Bar_Menu_Op, "积分I",         Menu_NULL_IMG,     Slide_space_PID_AI,                 0,     Menu_NULL_F},
    {18, 3,  Progress_Bar_Menu_Op, "微分D",         Menu_NULL_IMG,     Slide_space_PID_AD,                 0,     Menu_NULL_F},
    {18, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     16,                                 2,            *SaveTipConfig},

    {19, 0,  Title_Menu_Op,        "PID接近期",      Menu_NULL_IMG,     16,                                3,            *SaveTipConfig},
    {19, 1,  Progress_Bar_Menu_Op, "比例P",         Menu_NULL_IMG,     Slide_space_PID_CP,                 0,     Menu_NULL_F},
    {19, 2,  Progress_Bar_Menu_Op, "积分I",         Menu_NULL_IMG,     Slide_space_PID_CI,                 0,     Menu_NULL_F},
    {19, 3,  Progress_Bar_Menu_Op, "微分D",         Menu_NULL_IMG,     Slide_space_PID_CD,                 0,     Menu_NULL_F},
    {19, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     16,                                 3,            *SaveTipConfig},


    {20, 0,  Title_Menu_Op,        "温控设置",        Menu_NULL_IMG,     1,                                  4,     Menu_NULL_F},
    {20, 1,  Switch_Menu_Op,       "PID状态",       Menu_NULL_IMG,     SwitchSpace_PIDMode,                0,     Menu_NULL_F},
    {20, 2,  Progress_Bar_Menu_Op, "采样/加热 %",     Menu_NULL_IMG,     Slide_space_SamplingRatioWork,      0,     Menu_NULL_F},
    {20, 3,  Jump_Menu_Op,         "采样周期(ms)",    Menu_NULL_IMG,     22,                                 0,     Menu_NULL_F},
    {20, 4,  Jump_Menu_Op,         "卡尔曼滤波器",      Menu_NULL_IMG,     21,                                 0,     Menu_NULL_F},
    {20, 5,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     1,                                  4,     Menu_NULL_F},

    {21, 0,  Title_Menu_Op,        "卡尔曼滤波器",      Menu_NULL_IMG,     20,                                 4,     Menu_NULL_F},
    {21, 1,  Switch_Menu_Op,       "启用状态",        Menu_NULL_IMG,     SwitchSpace_KFP,                    0,     Menu_NULL_F},
    {21, 2,  Progress_Bar_Menu_Op, "过程噪声协方差",     Menu_NULL_IMG,     Slide_space_KFP_Q,                  0,     Menu_NULL_F},
    {21, 3,  Progress_Bar_Menu_Op, "观察噪声协方差",     Menu_NULL_IMG,     Slide_space_KFP_R,                  0,     Menu_NULL_F},
    {21, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     20,                                 4,     Menu_NULL_F},

    {22, 0,  Title_Menu_Op,        "采样周期",        Menu_NULL_IMG,     20,                                 3,     Menu_NULL_F},
    {22, 1,  Progress_Bar_Menu_Op, "温差>150",      Menu_NULL_IMG,     Slide_space_ADC_PID_Cycle_List_0,   0,     Menu_NULL_F},
    {22, 2,  Progress_Bar_Menu_Op, "温差>50",       Menu_NULL_IMG,     Slide_space_ADC_PID_Cycle_List_1,   0,     Menu_NULL_F},
    {22, 3,  Progress_Bar_Menu_Op, "温差≤50",       Menu_NULL_IMG,     Slide_space_ADC_PID_Cycle_List_2,   0,     Menu_NULL_F},
    {22, 4,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     20,                                 3,     Menu_NULL_F},

    {23, 0,  Title_Menu_Op,        "蓝牙",          Menu_NULL_IMG,     5,                                  2,     Menu_NULL_F},
    {23, 1,  Switch_Menu_Op,       "状态",          Menu_NULL_IMG,     SwitchSpace_BLE_State,              0,            *BLE_Restart},
    {23, 2,  F_Menu_Op,            "设备名称",        Menu_NULL_IMG,     23,                                 2,            *BLE_Rename},
    {23, 3,  Jump_Menu_Op,         "返回",          Menu_NULL_IMG,     5,                                  2,     Menu_NULL_F},
};
/***
 * @description: 快速打开热床列表
 * @param {*}
 * @return {*}
 */
