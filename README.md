...
[B站谢培宇x 适配好了MAX6675](https://b23.tv/DqndTQK)，[程序](https://pan.baidu.com/s/1FN_KfvtdgoIdXALv11UErQ) 提取码: 7fx5，VsCode环境搭建&程序烧录推荐看他的视频教程

### 热床功率过大导致开关电源限流保护

朱雀原程序有两组可配置的PID，一组负责爬升期，一组负责接近期
...
3. 加热有时oled花屏？
   ...
   此情况热床温度在100度以下时容易出现，来源于开关电源的电磁干扰，目前暂无比较好的解决方法，当热床温度到150度以上时这种现象消失
